  ...
  return (
    <>
      ...
      <div
        ...
        style={{ background: 'linear-gradient(180deg,#172033,#0f172a)', opacity: 0.9 }}
      >
        <div className="flex items-center justify-between text-sm font-black text-blue-200">
          <span>연습 중</span>
          <span className="rounded-full bg-white/10 px-2.5 py-1.5">◷ 00:42</span>
        </div>
        ...
        <div className="mt-4 rounded-[14px] bg-white/10 p-3.5 text-[12px] leading-relaxed text-blue-100">
          ...
          평소 IT 기술을 활용해 사람들의 생활을 편리하게 만드는 일에 관심이 많았습니다. 귀사의
          데이터 플랫폼은 다양한 산업에서 가치 있는 서비스를 제공하고 있어 이 곳에서 제 역량을
          발휘하고 싶어 지원했습니다.
        </div>
      </div>
